# ExMachina 协作连结体 · 校验连结体 · RUNTIME

运行时角色：support-link-body
来源：校验连结体
Inbox：`runtime/agents/exmachina-support-2/inbox`
Outbox：`runtime/agents/exmachina-support-2/outbox`
Status：`runtime/agents/exmachina-support-2/status.json`
