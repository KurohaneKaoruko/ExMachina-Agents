# ExMachina 主连结体 · 知识连结体 · RUNTIME

运行时角色：primary-link-body
来源：知识连结体
Inbox：`runtime/agents/exmachina-primary/inbox`
Outbox：`runtime/agents/exmachina-primary/outbox`
Status：`runtime/agents/exmachina-primary/status.json`
