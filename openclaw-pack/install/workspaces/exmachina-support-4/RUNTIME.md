# ExMachina 协作连结体 · 安全连结体 · RUNTIME

运行时角色：support-link-body
来源：安全连结体
Inbox：`runtime/agents/exmachina-support-4/inbox`
Outbox：`runtime/agents/exmachina-support-4/outbox`
Status：`runtime/agents/exmachina-support-4/status.json`
