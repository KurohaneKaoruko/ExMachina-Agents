# ExMachina 协作连结体 · 文档连结体 · RUNTIME

运行时角色：support-link-body
来源：文档连结体
Inbox：`runtime/agents/exmachina-support-3/inbox`
Outbox：`runtime/agents/exmachina-support-3/outbox`
Status：`runtime/agents/exmachina-support-3/status.json`
