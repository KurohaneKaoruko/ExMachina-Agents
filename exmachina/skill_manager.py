...
class SkillManager:
    ...
    def check_skill_status(self, skill_id: str) -> dict[str, Any]:
        """
        检查指定 skill 的安装状态
    ...
    def ensure_skills_installed(
        ...
        for skill_id in skill_ids:
            status = self.check_skill_status(skill_id)
            ...
            try:
                ...
                if result.returncode == 0:
                    ...
                    failed.append({"skill_id": skill_id, "error": result.stderr})
            except Exception as e:
                failed.append({"skill_id": skill_id, "error": str(e)})
    ...
    def generate_skill_bindings(
        ...
        for name in link_body_names:
            ...
            skill_entry = {
                ...
                "enabled": True,
                "priority": skill_info.get("priority", 50)
            }
            ...
            for kw in task_keywords:
                if kw in skill_keywords:
                    skill_entry["priority"] = min(skill_entry["priority"], 20)
                    break
    ...
    def export_skill_manifest(self, output_path: str | Path) -> None:
        """
